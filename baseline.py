...
def dataset_generator(target_dir,
                      normal_dir_name="FRESH520",
                      abnormal_dir_name="BROKEN520",
                      ext="wav"):
    """
    target_dir : str
    ...
    normal_files = sorted(glob.glob(
        os.path.abspath("{dir}/{normal_dir_name}/*.{ext}".format(dir=target_dir, normal_dir_name = normal_dir_name,
                                                                  ext=ext))))
    ...
    abnormal_files = sorted(glob.glob(
        os.path.abspath("{dir}/{abnormal_dir_name}/*.{ext}".format(dir=target_dir, abnormal_dir_name = abnormal_dir_name,
                                                                    ext=ext))))
    ...
    train_files = normal_files[len(abnormal_files):] # 59 to end of the list used for training
    train_labels = normal_labels[len(abnormal_files):]
    eval_files = numpy.concatenate((normal_files[:len(abnormal_files)], abnormal_files), axis=0) # A total of 120 Testing samples
